...
for (const token of ["getUserMedia", "MediaRecorder", "autocorrelate", "noteFromFrequency", "showToast", "renderRecords", "encodeWav", "encodeMp3", "updateToleranceVisualization", "applySettings", "recordingArmed", "evaluateAutomaticRecording", "beginAutomaticRecording"]) if (!js.includes(token)) failures.push(`app.js missing ${token}`);
